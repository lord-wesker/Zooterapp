    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                _mailHelper.SendMail(model.Username, "ZooterApp - Email confirmation", $"<h1>ZooterApp - Email Confirmation</h1>" +
                    $"To allow the user, " +
        ...
        public async Task<IActionResult> RecoverPassword(RecoverPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                _mailHelper.SendMail(model.Email, "ZooterApp Password Reset", $"<h1>ZooterApp Password Reset</h1>" +
